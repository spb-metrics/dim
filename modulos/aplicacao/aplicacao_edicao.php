...
if (file_exists("../../config/config.inc.php"))
{
 ...
 if ($_GET[id_aplicacao]!="")
 {
    ...
    //echo $aplicacao->executavel;
 }
 else
 {
    if(isset($_POST[id_aplicacao]))
    {
   	   $sql_alteracao = "update aplicacao
   	                       set
                           mostrar_resp_ope      = '$_POST[mostrar_responsavel_aplicacao]',
       ...
       if(mysqli_errno($db)=="0")
       {
         mysqli_commit($db);
         $aux=$_POST[aux];
         header("Location: ". URL."/modulos/aplicacao/aplicacao_inicial.php?a=t&".$aux);
       }
       else
       {
         mysqli_rollback($db);
         header("Location: ". URL."/modulos/aplicacao/aplicacao_inicial.php?a=f");
       }
    }
 }
    ...
    <tr>
      <td align="center" valign="top">
          <table width="100%" border="0" cellpadding="0" cellspacing="1">
            <form name="cadastro" id="cadastro" action="./aplicacao_edicao.php" method="POST" enctype="application/x-www-form-urlencoded">
            <tr>
              ...
              <td align="left" width="70%" class="campo_tabela">
                <input type="text" name="codigo" id="codigo" size="30" maxlength="10" <?php if (isset($id_aplicacao)){echo "value='".$id_aplicacao."'";}?> disabled>
              </td>
            ...
            <tr>
              ...
              <td align="left" width="25%"  class="campo_tabela" colspan="3">
                <input type="radio" name="mostrar_responsavel_aplicacao" value="S" <?php if($mostrar_responsavel_aplicacao=="S"){echo "checked";}?>>Sim &nbsp&nbsp&nbsp
                <input type="radio" name="mostrar_responsavel_aplicacao" value="" <?php if($mostrar_responsavel_aplicacao==""){echo "checked";}?>>Não
              </td>
            </tr>
