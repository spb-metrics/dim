...
if (file_exists("../../config/config.inc.php"))
{
 ...
 if($_SESSION[id_usuario_sistema]=='')
  ...
  {
     $string_query_registros = "select id_aplicacao, executavel, descricao from aplicacao
...
?>
    ...
    <table width="100%" height="100%" border="1" cellpadding="0" cellspacing="0">
      ...
      <tr>
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                  <form name="form_inicial" action="./aplicacao_inicial.php" method="POST" enctype="application/x-www-form-urlencoded">
                ...
                <td valign="middle" width="60%" >
                        ...
                        <select name="pesquisa" style="width:150px;">
                          <option <?php if ($_POST[pesquisa]=='executavel'){echo "selected";}?> value="executavel">Nome do Executável</option>
                          <option <?php if ($_POST[pesquisa]=='descricao'){echo "selected";}?> value="descricao">Aplicação</option>
                        </select>
                ...
                <td valign="middle" width="60%">
                  ...
                  <select name="indice" style="width:150px;">
                    <option <?php if ($_POST[indice]=='executavel'){echo "selected";}?> value="executavel">Nome do Executável</option>
                    <option <?php if ($_POST[indice]=='descricao'){echo "selected";}?> value="descricao">Aplicação</option>
                  </select>
                ...
                <td valign="middle" align="right" width="20%">
                  <?php
                    if($inclusao_perfil!=""){
                  ?>
                      <input style="font-size: 12px;" type="button" style="font-size: 12px;" name="cadastrar" value="Novo >>" onclick="window.location='<?php echo URL;?>/modulos/aplicacao/aplicacao_cadastro.php'">
                  <?php
                    }
                    else{
                  ?>
                      <input style="font-size: 12px;" type="button" style="font-size: 12px;" name="cadastrar" value="Novo >>" onclick="window.location='<?php echo URL;?>/modulos/aplicacao/aplicacao_cadastro.php'" disabled>
                  <?php
                    }
                  ?>
                </td>
        ...
        <tr bgcolor='#6B6C8F' class="coluna_tabela" height="18">
    ...
    <?php
      ...
      while ($aplicacao = mysqli_fetch_object($resultado_query_limite))
      {
         ...
         <tr class="linha_tabela" bgcolor='<?php echo $cor_linha;?>' onMouseOver="this.bgColor='#D9ECFF';" onMouseOut="this.bgColor='<?echo $cor_linha; ?>';">
           <td align='left'>
                <?php echo $aplicacao->executavel;?>
           </td>

           <td align='left'>
               <?php echo strtoupper($aplicacao->descricao);?>
           </td>
           ...
           <td align='center'>
             ...
             <?php
               ...
               if($consulta_perfil!=""){
             ?>
                 <a href='<?php echo URL;?>/modulos/aplicacao/aplicacao_detalhe.php?pagina=<?=$pagina_a_exibir-1?>&pagina_a_exibir=<?=$pagina_a_exibir?>&indice=<?=$_POST['indice']?>&buscar=<?=$_POST['buscar']?>&pesquisa=<?=$_POST['pesquisa']?>&id_aplicacao=<?php echo $aplicacao->id_aplicacao;?>'><img src="<?php echo URL;?>/imagens/b_search.png" border="0" title="Detalhar Registro"></a>&nbsp&nbsp&nbsp
             <?php
               }
             ?>
             <?php
               if($alteracao_perfil!=""){
             ?>
                 <a href='<?php echo URL;?>/modulos/aplicacao/aplicacao_edicao.php?pagina=<?=$pagina_a_exibir-1?>&pagina_a_exibir=<?=$pagina_a_exibir?>&indice=<?=$_POST['indice']?>&buscar=<?=$_POST['buscar']?>&pesquisa=<?=$_POST['pesquisa']?>&id_aplicacao=<?php echo $aplicacao->id_aplicacao;?>'><img src="<?php echo URL;?>/imagens/b_edit.gif" border="0" title="Editar Registro"></a>&nbsp&nbsp&nbsp
             <?php
               }
             ?>
             <?php
               if($exclusao_perfil!=""){
             ?>
                 <a href='<?php echo URL;?>/modulos/aplicacao/aplicacao_exclusao.php?pagina=<?=$pagina_a_exibir-1?>&pagina_a_exibir=<?=$pagina_a_exibir?>&indice=<?=$_POST['indice']?>&buscar=<?=$_POST['buscar']?>&pesquisa=<?=$_POST['pesquisa']?>&id_aplicacao=<?php echo $aplicacao->id_aplicacao;?>'><img src="<?php echo URL;?>/imagens/trash.gif" border="0" title="Excluir Registro"></a>
             <?php
               }
             ?>
...
<?
                      ...
                      ////////////////////////////////////////
                      $parte_url="/modulos/aplicacao/aplicacao_inicial.php";
...
<?php
    ...
    if($_GET[e]=='f'){echo "<script>window.alert('Não foi possível excluir a aplicação!')</script>";}

    if($_GET[i]=='t'){echo "<script>window.alert('Operação efetuada com sucesso!')</script>";}
    if($_GET[i]=='f'){echo "<script>window.alert('Não foi possível cadastrar a aplicação!')</script>";}

    if($_GET[a]=='t'){echo "<script>window.alert('Operação efetuada com sucesso!')</script>";}
    if($_GET[a]=='f'){echo "<script>window.alert('Não foi possível alterar a aplicação!')</script>";}
}
////////////////////////////////////////////
