            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_argumentos" action="altera_receita.php?aplicacao=<?php echo $_GET[aplicacao];?>" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr class="campo_botao_tabela" height="21">
                      ...
                      <?
                      $url = "./altera_receita.php?ano=" + $ano + "&numero=" + $numero + "&unidade=" + $unidade.value;
                      ?>
