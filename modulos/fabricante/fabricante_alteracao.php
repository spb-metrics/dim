...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: fabricante_alteracao.php
  //  Bancos...: dbtdim
  //  Data.....: 05/12/2006
  //  Analista.: Fabio Hitoshi Ide
  //  Função...: Tela de alteracao de fabricante
  //////////////////////////////////////////////////////////////////
  ...
  if(file_exists("../../config/config.inc.php")){
    ...
    if(isset($_POST[descricao])){
      ...
      $sql.="where id_fabricante='$_POST[codigo_antigo]'";
      mysqli_query($db, $sql);
      ...
      if(mysqli_errno($db)=="0"){
        mysqli_commit($db);
        $aux=$_POST[aux];
        header("Location: ". URL."/modulos/fabricante/fabricante_inicial.php?a=t&".$aux);
      }
      else{
        mysqli_rollback($db);
        header("Location: ". URL."/modulos/fabricante/fabricante_inicial.php?a=f");
      }
      exit();
    }
    else{
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_alteracao" action="./fabricante_alteracao.php" method="POST" enctype="application/x-www-form-urlencoded">
                    <tr class="titulo_tabela" height="21">
                      <td colspan="3" valign="middle" align="center" width="100%"> <?php echo $nome_aplicacao;?>: Alterar </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" colspan="2" valign="middle" width="100%">
                        <input type="text" name="descricao" size="30" style="width: 500px" value="<?php echo $fabricante_info->descricao?>">
                      </td>
                    </tr>
