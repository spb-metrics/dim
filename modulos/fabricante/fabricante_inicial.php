...
*/
  ...
  //  Função...: Tela inicial do módulo de fabricante
  //////////////////////////////////////////////////////////////////
                    ...
                    <tr class="opcao_tabela">
                      <td valign="middle" width="60%">
                        ...
                        <select name="pesquisa" style="width: 150px">
                          <option value="id_fabricante" <?php if($_POST[pesquisa]=="id_fabricante"){echo "selected";}?>> Código </option>
                      ...
                      <td valign="middle" width="40%">
                        ...
                        <select name="indice" style="width: 150px">
                          <option value="id_fabricante" <?php if($_POST[indice]=="id_fabricante"){echo "selected";}?>> Código </option>
...
<?php
    ...
    if($_GET[e]=='f'){echo "<script>window.alert('Não foi possível excluir o fabricante!')</script>";}
  
    if($_GET[i]=='t'){echo "<script>window.alert('Operação efetuada com sucesso!')</script>";}
    if($_GET[i]=='f'){echo "<script>window.alert('Não foi possível cadastrar o fabricante!')</script>";}
  
    if($_GET[a]=='t'){echo "<script>window.alert('Operação efetuada com sucesso!')</script>";}
    if($_GET[a]=='f'){echo "<script>window.alert('Não foi possível alterar o fabricante!')</script>";}
  }
  ////////////////////////////////////////////
