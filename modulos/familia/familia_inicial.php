...
*/
  ...
  //  Função...: Tela inicial do módulo de familias
  //////////////////////////////////////////////////////////////////
...
<?
          ...
          $paginacao       = 17; //quantidade de registros por página
                    ...
                    <tr class="opcao_tabela">
                      <td valign="middle" width="60%">
                        ...
                        <select name="pesquisa" style="width: 150px">
                            ...
                            <option value="descricao" <?php if($_POST[pesquisa]=="descricao"){echo "selected";}?>> Família </option>
                        </select>
                      ...
                      <td valign="middle" width="40%">
                        ...
                        <select name="indice" style="width: 150px">
                            ...
                            <option value="descricao" <?php if($_POST[indice]=="descricao"){echo "selected";}?>> Família </option>
                        </select>
...
<?php
    ...
    if($_GET[e]=='f'){echo "<script>window.alert('Não foi possível excluir a família!')</script>";}
  
    if($_GET[i]=='t'){echo "<script>window.alert('Operação efetuada com sucesso!')</script>";}
    if($_GET[i]=='f'){echo "<script>window.alert('Não foi possível cadastrar a família!')</script>";}
  
    if($_GET[a]=='t'){echo "<script>window.alert('Operação efetuada com sucesso!')</script>";}
    if($_GET[a]=='f'){echo "<script>window.alert('Não foi possível alterar a família!')</script>";}
  }
  ////////////////////////////////////////////
