...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: gatencao_inclusao.php
  //  Bancos...: dbtdim
  //  Data.....: 27/11/2006
  //  Analista.: Fabio Hitoshi Ide
  //  Função...: Tela de inclusao de grupo de atencao
  //////////////////////////////////////////////////////////////////
  ...
  if(file_exists("../../config/config.inc.php")){
    ...
    if(isset($_POST[descricao])){
      ...
      $sql="insert into atencao_continuada (descricao, status_2, data_incl, usua_incl) ";
      ...
      if(mysqli_errno($db)=="0"){
        mysqli_commit($db);
        header("Location: ". URL."/modulos/gatencao/gatencao_inicial.php?i=t");
      }
      else{
        mysqli_rollback($db);
        header("Location: ". URL."/modulos/gatencao/gatencao_inicial.php?i=f");
      }
      exit();
    }
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_inclusao" action="./gatencao_inclusao.php" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr class="campo_botao_tabela" height="35">
                      <td colspan="3"valign="middle" align="right" width="100%">
                        <input type="button" style="font-size: 12px;" name="voltar" value="<< Voltar" onclick="window.location='<?php echo URL;?>/modulos/gatencao/gatencao_inicial.php'">
