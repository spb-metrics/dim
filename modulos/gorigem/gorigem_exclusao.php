...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: gorigem_exclusao.php
  //  Bancos...: dbtdim
  //  Data.....: 27/11/2006
  //  Analista.: Fabio Hitoshi Ide
  //  Função...: Tela de exclusao de grupo origem
  //////////////////////////////////////////////////////////////////
  ...
  if(file_exists("../../config/config.inc.php")){
    ...
    if(isset($_POST[codigo_atual])){
      ...
      $sql="update grupo_origem ";
      $sql.="set status_2='I', data_alt='$data', usua_alt='$_SESSION[id_usuario_sistema]' ";
      $sql.="where id_grupo_origem='$_POST[codigo_atual]'";
      mysqli_query($db, $sql);
      erro_sql("Update Grupo Origem", $db, "");
      ...
      if(mysqli_errno($db)=="0"){
        mysqli_commit($db);
        $aux=$_POST[aux];
        header("Location: ". URL."/modulos/gorigem/gorigem_inicial.php?e=t&".$aux);
      }
      else{
        mysqli_rollback($db);
        header("Location: ". URL."/modulos/gorigem/gorigem_inicial.php?e=f");
      }
      exit();
    }
    else{
      if($_GET[codigo]==""){
        header("Location: ". URL."/modulos/gorigem/gorigem_inicial.php");
        exit();
      }
      else{
        $sql="select id_grupo_origem, descricao from grupo_origem where id_grupo_origem='$_GET[codigo]'";
        $res=mysqli_query($db, $sql);
        erro_sql("Select Grupo Origem Escolhido", $db, "");
    ...
    <!--
      function trataDados(){
        ...
        if(info=="SAV"){
          ...
          var msg="Não é possível excluir o grupo origem, pois existe sub-grupo origem associado!\n";
          window.alert(msg);
        }
      }
      ...
      function verificarExclusao(){
        ...
        var url = "../../xml/gorigemExclusao.php?id=" + id;
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_exclusao"action="./gorigem_exclusao.php" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" colspan="2" valign="middle" width="75%">
                        <input type="text" name="codigo" size="30" style="width: 200px" disabled value="<?php echo $grupo_info->id_grupo_origem?>">
                      </td>
                    </tr>
                    <tr>
                      <td class="descricao_campo_tabela" valign="middle" width="25%">
                    ...
                    <tr class="campo_botao_tabela" height="35">
                      <td colspan="3" valign="middle" align="right" width="100%">
                        <input type="button" style="font-size: 12px;" name="voltar" value="<< Voltar" onclick="window.location='<?php echo URL;?>/modulos/gorigem/gorigem_inicial.php?pagina=<?=$_GET[pagina]?>&pagina_a_exibir=<?=$_GET[pagina_a_exibir]?>&buscar=<?=$_GET[buscar]?>&indice=<?=$_GET[indice]?>&pesquisa=<?=$_GET[pesquisa]?>'">
