...
*/
  ...
  if(file_exists("../../config/config.inc.php")){
    ...
    if(isset($_POST[descricao])){
      ...
      $sql="update grupo ";
      $sql.="set descricao='" . trim(strtoupper($_POST[descricao])) . "', flg_tipo_obrigatorio='$_POST[tipo]', status_2='A', data_alt='$data', usua_alt='$_SESSION[id_usuario_sistema]' ";
      $sql.="where id_grupo='$_POST[codigo_antigo]'";
      mysqli_query($db, $sql);
      erro_sql("Update Grupo", $db, "");
      ...
      if(mysqli_errno($db)=="0"){
        mysqli_commit($db);
        $aux=$_POST[aux];
        header("Location: ". URL."/modulos/grupo/grupo_inicial.php?a=t&".$aux);
      }
      else{
        mysqli_rollback($db);
        header("Location: ". URL."/modulos/grupo/grupo_inicial.php?a=f");
      }
      exit();
    }
    else{
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_alteracao" action="./grupo_alteracao.php" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" colspan="2" valign="middle" width="100%">
                        <input type="radio" value="S" name="tipo" <?php if($grupo_info->flg_tipo_obrigatorio=="S"){echo "checked";}?>> Sim
                        &nbsp; &nbsp; &nbsp; &nbsp;
                        <input type="radio" value="N" name="tipo" <?php if($grupo_info->flg_tipo_obrigatorio=="N"){echo "checked";}?>> Não
                      </td>
                    </tr>
