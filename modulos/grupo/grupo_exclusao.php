...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: grupo_exclusao.php
  //  Bancos...: dbtdim
  //  Data.....: 27/11/2006
  //  Analista.: Fabio Hitoshi Ide
  //  Função...: Tela de exclusao de grupo
  //////////////////////////////////////////////////////////////////
  ...
  if(file_exists("../../config/config.inc.php")){
    ...
    if(isset($_POST[codigo_atual])){
      ...
      $sql.="where id_grupo='$_POST[codigo_atual]'";
      mysqli_query($db, $sql);
      ...
      if(mysqli_errno($db)=="0"){
        mysqli_commit($db);
        $aux=$_POST[aux];
        header("Location: ". URL."/modulos/grupo/grupo_inicial.php?e=t");
		//echo URL."/modulos/grupo/grupo_inicial.php?e=t ".$aux;
		//exit;
        //header("Location: ". URL."/modulos/grupo/grupo_inicial.php");
      }
      else{
        mysqli_rollback($db);
        header("Location: ". URL."/modulos/grupo/grupo_inicial.php?e=f");
      }
      exit();
    }
    else{
    ...
    <!--
      function trataDados(){
        ...
        if(info=="SAV"){
          ...
          var msg="Não é possível excluir o grupo, pois existe sub-grupo associado!\n";
          window.alert(msg);
        }
      }
      ...
      function verificarExclusao(){
        ...
        var url = "../../xml/grupoExclusao.php?id=" + id;
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_exclusao"action="./grupo_exclusao.php" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" colspan="2" valign="middle" width="100%">
                        ...
                        &nbsp; &nbsp; &nbsp; &nbsp;
                        <input type="radio" value="N" name="tipo" disabled <?php if($grupo_info->flg_tipo_obrigatorio=="N"){echo "checked";}?>> Não
                      </td>
                    </tr>
