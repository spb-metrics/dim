...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: grupo_inclusao.php
  //  Bancos...: dbtdim
  //  Data.....: 27/11/2006
  //  Analista.: Fabio Hitoshi Ide
  //  Função...: Tela de inclusao de grupo
  //////////////////////////////////////////////////////////////////
  ...
  if(file_exists("../../config/config.inc.php")){
    ...
    if(isset($_POST[descricao])){
      ...
      $sql.="values ('" . trim(strtoupper($_POST[descricao])) . "', '$_POST[tipo]', 'A', '$data', '$_SESSION[id_usuario_sistema]')";
      mysqli_query($db, $sql);
      ...
      if(mysqli_errno($db)=="0"){
        mysqli_commit($db);
        header("Location: ". URL."/modulos/grupo/grupo_inicial.php?i=t");
      }
      else{
        mysqli_rollback($db);
        header("Location: ". URL."/modulos/grupo/grupo_inicial.php?i=f");
      }
      exit();
    }
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_inclusao" action="./grupo_inclusao.php" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr height="21">
                      ...
                      <td class="campo_tabela" colspan="2" valign="middle" width="100%">
                        ...
                        &nbsp; &nbsp; &nbsp; &nbsp;
                        <input type="radio" value="N" name="tipo" checked> Não
                      </td>
                    </tr>
                    <tr class="campo_botao_tabela" height="35">
                      <td colspan="3"valign="middle" align="right" width="100%">
                        <input type="button" style="font-size: 12px;" name="voltar" value="<< Voltar" onclick="window.location='<?php echo URL;?>/modulos/grupo/grupo_inicial.php'">
