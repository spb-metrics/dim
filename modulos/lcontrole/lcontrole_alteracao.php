...
*/
  ...
  //  Função...: Tela de alteracao de lista de controle
  //////////////////////////////////////////////////////////////////
                  ...
                  <form name="form_alteracao" action="./lcontrole_alteracao.php" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr>
                        ...
                        <td align="left" width="30%" class="campo_tabela">
                          ...
                          &nbsp; &nbsp; &nbsp; &nbsp;
                          <input type="radio" name="controlada" value="" <?php if($lista_info->flg_receita_controlada!="S"){echo "checked";}?>> Não
                        </td>
                        ...
                        <td align="left" width="30%" class="campo_tabela">
                          ...
                          &nbsp; &nbsp; &nbsp; &nbsp;
                          <input type="radio" name="medicontrolado" value=""<?php if($lista_info->flg_medicamento_controlado!="S"){echo "checked";}?>> Não
                      </td>
                    </tr>
