...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: livro_exclusao.php
  //  Bancos...: dbtdim
  //  Data.....: 28/11/2007
  //  Analista.: Ricieri Rocha Conz
  //  Função...: Tela de exclusão do Livro
  //////////////////////////////////////////////////////////////////
 ...
 <script language="JavaScript" type="text/javascript" src="../../scripts/ajax.js"></script>
    ...
    <!--
      function trataDados(){
        ...
        if(info=="NAO"){
          window.location='<?php echo URL;?>/modulos/livro/livro_inicial.php?e=r';
        }
        else if(info=="SAV"){
               var aux = x.aux.value;
               window.location='<?php echo URL;?>/modulos/livro/livro_inicial.php?e=t&'+aux;
        }
        else if(info=="ERR"){
               window.location='<?php echo URL;?>/modulos/livro/livro_inicial.php?e=f';
               }
      }
      ...
      function verificarExclusao(){
        ...
        var url = "../../xml/LivroExclusao.php?codigo=" + id;
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_exclusao"action="./livro_exclusao.php" method="POST" enctype="application/x-www-form-urlencoded">
...
<?php
    ...
    if($_GET[e]=='f'){echo "<script>window.alert('Não é possível excluir o Livro!')</script>";}
