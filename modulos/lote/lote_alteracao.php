...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: lote_alteracao.php
  //  Bancos...: dbtdim
  //  Data.....: 27/11/2006
  //  Analista.: Fabio Hitoshi Ide
  //  Função...: Tela de alteracao de lote
  //////////////////////////////////////////////////////////////////
  ...
  if(file_exists("../../config/config.inc.php")){
    ...
    if(isset($_POST[bloqueado]) && isset($_POST[motivo])){
      $data=date("Y-m-d H:i:s");
      $sql="update estoque ";
      $sql.="set flg_bloqueado='$_POST[bloqueado]', motivo_bloqueio='" . strtoupper($_POST[motivo]) . "', data_alt='$data', usua_alt='$_SESSION[id_usuario_sistema]' ";
      $sql.="where lote='$_POST[lote_atual]' and material_id_material='$_POST[material_atual]' and fabricante_id_fabricante='$_POST[fabricante_atual]'";
      mysqli_query($db, $sql);
      ...
      if(mysqli_errno($db)=="0"){
        mysqli_commit($db);
        $aux=$_POST[aux];
        header("Location: ". URL."/modulos/lote/lote_inicial.php?a=t&".$aux);
      }
      else{
        mysqli_rollback($db);
        header("Location: ". URL."/modulos/lote/lote_inicial.php?a=f");
      }
      exit();
    }
    else{
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_alteracao" action="./lote_alteracao.php" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" colspan="3" valign="middle" width="100%">
                        <input type="radio" value="S" name="bloqueado" <?php if($consulta->flg_bloqueado=="S"){echo "checked";}?>> Sim
                        &nbsp; &nbsp; &nbsp; &nbsp;
                        <input type="radio" value="" name="bloqueado" <?php if($consulta->flg_bloqueado==""){echo "checked";}?>> Não
                      </td>
                    </tr>
                    <tr>
                      <td class="descricao_campo_tabela" valign="middle" width="20%">
                      ...
                      <td class="campo_tabela" colspan="3" valign="middle" width="100%">
                        <textarea name="motivo" row="2" cols="31" style="width: 500px"><?php echo $consulta->motivo_bloqueio;?></textarea>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="4">
                        <table cellpadding='0' cellspacing='1' border='0' width='100%'>
                          ...
                          ?>
                              <tr class="linha_tabela" bgcolor='<?php echo $cor_linha;?>'>
                                <td align="left"> <?php echo $estoque_bloqueado->nome;?> </td>
                                <td align="right"> <?php echo (int)$estoque_bloqueado->quantidade;?> </td>
                              </tr>
                          <?php
                              ////////////////////////
                    ...
                    <tr class="campo_botao_tabela">
                      <td colspan="4" valign="middle" align="right" width="100%">
                        ...
                        <input type="button" name="salvar" style="font-size: 12px;" value="Salvar >>" onclick="this.disabled='true';document.form_alteracao.submit();">
                      </td>
                    </tr>
                    ...
                    <input type="hidden" name="material_atual" value="<?php echo $consulta->id_material;?>">
                    <input type="hidden" name="lote_atual" value="<?php echo $consulta->lote;?>">
                    <input type="hidden" name="fabricante_atual" value="<?php echo $consulta->id_fabricante;?>">
