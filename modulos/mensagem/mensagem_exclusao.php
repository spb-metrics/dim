  ...
  if (file_exists("../../config/config.inc.php")){
    ...
    if($_GET[codigo]!=""){
      ...
      if(mysqli_errno($db)=="0"){
        mysqli_commit($db);
        header("Location: ". URL."/modulos/mensagem/mensagem_inicial.php?e=t");
      }
      else{
        mysqli_rollback($db);
        header("Location: ". URL."/modulos/mensagem/mensagem_inicial.php?e=f");
      }
    }
    ////////////////////////////////////
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_inclusao" action="./mensagem_exclusao.php" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr class="campo_botao_tabela" height="35">
                      <td colspan="4"valign="middle" align="right" width="100%">
                        ...
                        <input type="submit" name="salvar" style="font-size: 12px;" value="Excluir >>">
                      </td>
                    </tr>
