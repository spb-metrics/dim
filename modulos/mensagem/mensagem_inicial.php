                    ...
                    <tr class="opcao_tabela">
                      <td valign="middle" width="60%">
                        ...
                        <select name="pesquisa" style="width: 150px">
                            ...
                            <option value="data_inicio" <?php if($_POST[pesquisa]=="data_inicio"){echo "selected";}?>> Data Início </option>
                            <option value="data_fim" <?php if($_POST[pesquisa]=="data_fim"){echo "selected";}?>> Data Fim </option>
                            <option value="status_2" <?php if($_POST[pesquisa]=="status_2"){echo "selected";}?>> Situação </option>
                        </select>
                      ...
                      <td valign="middle" width="40%">
                        ...
                        <select name="indice" style="width: 150px">
                            ...
                            <option value="data_inicio" <?php if($_POST[indice]=="data_inicio"){echo "selected";}?>> Data Início </option>
                            <option value="data_fim" <?php if($_POST[indice]=="data_fim"){echo "selected";}?>> Data Fim </option>
                            <option value="status_2" <?php if($_POST[indice]=="status_2"){echo "selected";}?>> Situação </option>
                        </select>
...
<?php
    ...
    if($_GET[e]=='f'){echo "<script>window.alert('Não foi possível excluir a mensagem!')</script>";}
  
    if($_GET[i]=='t'){echo "<script>window.alert('Operação efetuada com sucesso!')</script>";}
    if($_GET[i]=='f'){echo "<script>window.alert('Não foi possível cadastrar a mensagem!')</script>";}

    if($_GET[a]=='t'){echo "<script>window.alert('Operação efetuada com sucesso!')</script>";}
    if($_GET[a]=='f'){echo "<script>window.alert('Não foi possível alterar a mensagem!')</script>";}
  }
  ////////////////////////////////////////////
