...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: motivofr_detalhado.php
  //  Bancos...: dbmdim
  //  Função...: Tela de detalhação do Motivo Fim Receita
  //////////////////////////////////////////////////////////////////
  ...
  if (file_exists("../../config/config.inc.php"))
  {
    ...
    if($_GET[codigo]==""){
      ...
      erro_sql("Select Detalhado Motivo Fim Receita", $db, "");
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_detalhado" action="./motivofr_detalhado.php" method="POST" enctype="application/x-www-form-urlencoded">
