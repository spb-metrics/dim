...
*/
  ...
  //  Bancos...: dbmdim
  //  Função...: Tela de exclusão do Motivo Fim Receita
  //////////////////////////////////////////////////////////////////
  ...
  if (file_exists("../../config/config.inc.php"))
  {
    ...
    if($_SESSION[id_usuario_sistema]=='')
    {
     ...
     if($_GET[codigo]==" "){
        ...
        erro_sql("Select Alteração Motivo Fim Receita", $db, "");
...
<?php
    ...
    if($_GET[e]=='f'){echo "<script>window.alert('Não é possível excluir o Motivo Fim Receita!')</script>";}
