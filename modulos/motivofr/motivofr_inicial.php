...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: motivofr_inicial.php
  //  Bancos...: dbmdim
  //  Função...: Tela inicial do Cadastro de Motivo fim receita
  //////////////////////////////////////////////////////////////////
...
<?
          ...
          {
             $string_query_registros = "select idmotivo_fim_receita, motivo from motivo_fim_receita
          ...
          {
            if(!$_POST['indice']){$_POST['indice']="motivo";}
            $string_query_registros = "select idmotivo_fim_receita, motivo from motivo_fim_receita where status_2='A' order by ".$_POST['indice'];
          }
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                  <form name="form_inicial" action="./motivofr_inicial.php" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr class="opcao_tabela">
                      <td valign="middle" width="60%">
                        ...
                        <select name="pesquisa" style="width: 150px">
                          <option value="idmotivo_fim_receita" <?php if($_POST[pesquisa]=="idmotivo_fim_receita"){echo "selected";}?>> Código </option>
                          <option value="motivo" <?php if($_POST[pesquisa]=="motivo"){echo "selected";}?>> Motivo </option>
                        </select>
                      ...
                      <td valign="middle" width="40%">
                        ...
                        <select name="indice" style="width: 150px">
                          <option value="idmotivo_fim_receita" <?php if($_POST[indice]=="idmotivo_fim_receita"){echo "selected";}?>> Código </option>
                          <option value="motivo" <?php if($_POST[indice]=="motivo"){echo "selected";}?>> Motivo </option>
                        </select>
                      ...
                      <td valign="middle" align="right" width="20%">
                        <?php
                          if($inclusao_perfil!=""){
                        ?>
                            <input type="button" style="font-size: 12px;" name="cadastrar" value="Novo >>" onclick="window.location='<?php echo URL;?>/modulos/motivofr/motivofr_inclusao.php'">
                        <?php
                          }
                          else{
                        ?>
                            <input type="button" style="font-size: 12px;" name="cadastrar" value="Novo >>" onclick="window.location='<?php echo URL;?>/modulos/motivofr/motivofr_inclusao.php'" disabled>
                        <?php
                          }
                        ?>
                      </td>
...
?>
               ...
               <tr class="linha_tabela" bgcolor='<?php echo $cor_linha;?>' onMouseOver="this.bgColor='#D4DFED';" onMouseOut="this.bgColor='<?php echo $cor_linha;?>'">
                 <td align='left'>
                    <?php echo $grupo_info->idmotivo_fim_receita;?>
                 </td>

                 <td align='left'>
                    <?php echo $grupo_info->motivo;?>
                 </td>
                 <td align='center'>
                   <?php
                     if ($pagina_a_exibir=="")
                     ...
                     if($consulta_perfil!=""){
                   ?>
                     <a href='<?php echo URL;?>/modulos/motivofr/motivofr_detalhado.php?pagina=<?=$pagina_a_exibir-1?>&pagina_a_exibir=<?=$pagina_a_exibir?>&indice=<?=$_POST['indice']?>&buscar=<?=$_POST['buscar']?>&pesquisa=<?=$_POST['pesquisa']?>&codigo=<?php echo $grupo_info->idmotivo_fim_receita;?>'><img src="<?php echo URL;?>/imagens/b_search.png" border="0" title="Detalhar Registro"></a>&nbsp&nbsp&nbsp
                   <?php
                     }
                   ?>
                   <?php
                     if($alteracao_perfil!=""){
                   ?>
                     <a href='<?php echo URL;?>/modulos/motivofr/motivofr_alteracao.php?pagina=<?=$pagina_a_exibir-1?>&pagina_a_exibir=<?=$pagina_a_exibir?>&indice=<?=$_POST['indice']?>&buscar=<?=$_POST['buscar']?>&pesquisa=<?=$_POST['pesquisa']?>&codigo=<?php echo $grupo_info->idmotivo_fim_receita;?>'><img src="<?php echo URL;?>/imagens/b_edit.gif" border="0" title="Editar Registro"></a>&nbsp&nbsp&nbsp
                   <?php
                     }
                   ?>
                   <?php
                     if($exclusao_perfil!=""){
                   ?>
                     <a href='<?php echo URL;?>/modulos/motivofr/motivofr_exclusao.php?pagina=<?=$pagina_a_exibir-1?>&pagina_a_exibir=<?=$pagina_a_exibir?>&indice=<?=$_POST['indice']?>&buscar=<?=$_POST['buscar']?>&pesquisa=<?=$_POST['pesquisa']?>&codigo=<?php echo $grupo_info->idmotivo_fim_receita;?>'><img src="<?php echo URL;?>/imagens/trash.gif" border="0" title="Excluir Registro"></a>
                   <?php
                     }
                   ?>
                 </td>
...
<?
                      ...
                      ////////////////////////////////////////
                      $parte_url="/modulos/motivofr/motivofr_inicial.php";
...
<?php
    ...
    if($_GET[e]=='f'){echo "<script>window.alert('Não foi possível excluir o Motivo!')</script>";}
    if($_GET[e]=='r'){echo "<script>window.alert('Não é possível excluir o motivo, pois existem receitas associadas')</script>";}
    
    if($_GET[i]=='t'){echo "<script>window.alert('Operação realizada com sucesso!')</script>";}
    if($_GET[i]=='f'){echo "<script>window.alert('Não foi possível cadastrar o Motivo!')</script>";}
  
    if($_GET[a]=='t'){echo "<script>window.alert('Operação realizada com sucesso!')</script>";}
    if($_GET[a]=='f'){echo "<script>window.alert('Não foi possível alterar o Motivo!')</script>";}
  }
  ////////////////////////////////////////////
