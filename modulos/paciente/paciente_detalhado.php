...
*/
  ...
  if(file_exists("../../config/config.inc.php")){
    ...
    if($_GET[id_paciente]!=""){
       $sql="select id_status_paciente, unidade_cadastro, unidade_referida, cidade_id_cidade,
            ...
            <tr>
              <td colspan='4'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_detalhado" action="./paciente_detalhado.php" method="POST" enctype="application/x-www-form-urlencoded">
                    <tr class="titulo_tabela" height="21">
                      <td colspan="6" valign="middle" align="center" width="100%"> <?php echo $nome_aplicacao;?>: Detalhar </td>
                    </tr>
                    <tr>
                      ...
                      <td class="campo_tabela" valign="middle" width="50%" colspan="3">
                        <input type="text" name="nome" id="nome" size="60"  maxlength="70" value="<?php echo $nome;?>" disabled>
                      </td>
                      ...
                      <td class="campo_tabela" valign="middle" width="12%">
                        <input type="text" name="data_nasc" id="data_nasc" size="10"  maxlength="10" value="<?php echo $data_nasc;?>" disabled>
                      </td>
                    </tr>
                    <tr>
                      <td class="descricao_campo_tabela" valign="middle" width="20%">
                      ...
                      <td class="campo_tabela" colspan="3" valign="middle" width="50%">
                        <input type="text" name="mae" id="mae" size="60" maxlength="70" value="<?php echo $mae;?>" disabled>
                      </td>
                      <td class="descricao_campo_tabela" valign="middle" width="18%">
                        <IMG SRC='<?php echo URL; ?>/imagens/obrigat.gif' BORDER='0'>
                         Sexo
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" valign="middle" width="80%" colspan="3">
                        <input type="text" name="cpf" id="cpf" size="30" maxlength="30" value="<?php echo $cpf;?>" disabled>
                      </td>
                      <td class="descricao_campo_tabela" valign="middle" width="20%">
                        <IMG SRC='<?php echo URL; ?>/imagens/obrigat_1.gif' BORDER='0'>
                        Telefone
                      ...
                      <td class="campo_tabela" valign="middle" width="12%">
                        <input type="text" name="telefone" id="telefone" size="10" maxlength="12" value="<?php echo $telefone;?>" disabled>
                      </td>
                    </tr>
                    <tr>
                      <td class="descricao_campo_tabela" valign="middle" width="20%">
                      ...
                      <td class="campo_tabela" valign="middle" width="50%" colspan="3">
                        <input type="text" name="logradouro" id="logradouro" size="63" maxlength="50" value="<?php echo $logradouro;?>" disabled>
                      </td>
                    </tr>
                    <tr>
                      <td class="descricao_campo_tabela" valign="middle" width="20%">
                      ...
                      <td class="campo_tabela" valign="middle" width="15%">
                        <input type="text" name="numero" id="numero" size="12" maxlength="7" value="<?php echo $numero;?>" disabled>
                      </td>
                      <td class="descricao_campo_tabela" valign="middle" width="20%">
                        <IMG SRC='<?php echo URL; ?>/imagens/obrigat_1.gif' BORDER='0'>
                        Complemento
                      ...
                      <td class="campo_tabela" valign="middle" width="30%" colspan="3">
                        <input type="text" name="complemento" id="complemento" size="63" maxlength="15" value="<?php echo $complemento;?>" disabled>
                      </td>
                    </tr>
                    <tr>
                      <td class="descricao_campo_tabela" valign="middle" width="20%">
                      ...
                      <td class="campo_tabela" valign="middle" width="80%" colspan="5">
                        <input type="text" name="bairro" id="bairro" size="45" maxlength="30" value="<?php echo $bairro;?>" disabled>
                      </td>
                    </tr>
                    <tr>
                      <td class="descricao_campo_tabela" valign="middle" width="20%">
                      ...
                      <td class="campo_tabela" valign="middle" width="80%" colspan="5">
                        ...
                        ?>
                        <input type="text" size="45" name="cidade_receita" id="cidade_receita" value="<?php echo $listacidade->cidade; ?>" disabled>
                      </td>
                    </tr>
                    <tr>
                      <td class="descricao_campo_tabela" valign="middle" width="20%">
							  ...
							  <td colspan="6">
							    <table width="100%" cellpadding="0" cellspacing="1">
                                  ...
                                  <?php
                                    ...
                                    $contpront=1;
                                    while($listapront = mysqli_fetch_object($prontuarios)){
                                  ?>
                                      <tr class="campo_tabela">
  								        <td align="left"><?php echo $listapront->num_prontuario;?></td>
									    <td align="left"><?php echo $listapront->nome;?></td>
  						              </tr>
                                  <?php
                                      $contpront++;
                                    }
						    ...
						    <tr>
							  <td colspan="6">
							    <table width="100%" cellpadding="0" cellspacing="1">
                                  ...
                                  <?php
                                    //mostrar as atencoes continuadas
                    ...
                    <tr height="35">
                      <td colspan="6" align="right" class="descricao_campo_tabela">
                        <input style="font-size: 12px;" type="button" name="voltar" id="voltar" value="<< Voltar"  onClick="window.location='<?php echo URL;?>/modulos/paciente/paciente_inicial.php?id_paciente=<?php echo $_GET[id_paciente];?>'">
                      </td>
                    </tr>
                    <tr height="21">
