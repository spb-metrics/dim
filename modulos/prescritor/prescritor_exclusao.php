...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: prescritor_exclusao.php
  //  Bancos...: dbtdim
  //  Data.....: 27/11/2006
  //  Analista.: Fabio Hitoshi Ide
  //  Função...: Tela de exclusao de prescritor
  //////////////////////////////////////////////////////////////////
  ...
  if(file_exists("../../config/config.inc.php")){
    ...
    if(isset($_POST[codigo_atual])){
      ...
      $sql.="where id_tipo_prescritor='$_POST[codigo_atual]'";
      mysqli_query($db, $sql);
      ...
      if(mysqli_errno($db)=="0"){
        mysqli_commit($db);
        $aux=$_POST[aux];
        header("Location: ". URL."/modulos/prescritor/prescritor_inicial.php?e=t&".$aux);
      }
      else{
        mysqli_rollback($db);
        header("Location: ". URL."/modulos/prescritor/prescritor_inicial.php?e=f");
      }
      exit();
    }
    else{
    ...
    <!--
      function trataDados(){
        ...
        if(info=="SAV"){
          ...
          var msg="Não é possível excluir o prescritor, pois existe profissional associado!\n";
          window.alert(msg);
        }
      }
      ...
      function verificarExclusao(){
        ...
        var url = "../../xml/prescritorExclusao.php?id=" + id;
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_exclusao"action="./prescritor_exclusao.php" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" colspan="2" valign="middle" width="100%">
                        <input type="text" name="descricao" size="30" style="width: 200px" disabled value="<?php echo $prescritor_info->descricao?>">
                      </td>
                    </tr>
                    <tr>
                      <td class="descricao_campo_tabela" valign="middle" width="20%">
                      ...
                      <td class="campo_tabela" colspan="2" valign="middle" width="100%">
                        <select name="conselho" size="1" disabled style="width: 200px">
                          <option value="0"> Selecione um Conselho </option>
                          <?php
                            $sql="select id_tipo_conselho, descricao from tipo_conselho order by descricao";
                            $res=mysqli_query($db, $sql);
