...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: profissional_detalhado.php
  //  Bancos...: dbtdim
  //  Data.....: 27/11/2006
  //  Analista.: Fabio Hitoshi Ide
  //  Função...: Tela de detalhacao de profissional
  //////////////////////////////////////////////////////////////////
  ...
  if (file_exists("../../config/config.inc.php"))
  {
    ...
    if($_GET[codigo]==""){
      ...
      erro_sql("Select Profissinal Escolhido", $db, "");
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_detalhado" action="./profissional_detalhado.php" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" colspan="3" valign="middle" width="100%">
                        <select name="profissional" size="1" style="width: 200px" disabled>
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" valign="middle" width="30%" colspan="3">
                        <select name="uf" size="1" disabled style="width: 200px">
