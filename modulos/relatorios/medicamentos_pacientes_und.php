...
// | Arquivo ............: medicamentos_pacientes_und.php                            |
// | Autor ..............: José Renato C. P. Barbosa <jrenato.barbosa@ima.sp.gov.br> |
// +---------------------------------------------------------------------------------+
// | Função .............: Tela de argumentos do Relatório Med Ret Pac de Outras Unds|
// | Data de Criação ....: 22/01/2007 - 13:15                                        |
// | Última Atualização .: 16/03/2007 - 13:40                                        |
// | Versão .............: 1.0.0                                                     |
// +---------------------------------------------------------------------------------+
...
function exportar01()
{
 document.form_argumentos.action = "relatorio_med_pac_und_csv.php";
...
function exportar02()
{
 document.form_argumentos.action = "relatorio_med_pac_und_pdf.php";
 document.form_argumentos.method = "POST";
 document.form_argumentos.target = "_blank";
 document.form_argumentos.submit();
 return false;
                ...
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_argumentos" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" valign="middle" width="25%">
                        <input type="text" name="data_fn" size="15" style="width: 80px" onFocus=" nextfield ='unidade01'" value="<?=date("d/m/Y")?>" onblur="verificaData(this,this.value);" onKeyPress="return mascara_data(event,this);" value="<?=$data_fn?>">
                      </td>
                    </tr>
                    <tr>
                      <td class="descricao_campo_tabela" valign="middle" width="25%">
                        <IMG SRC='<?php echo URL; ?>/imagens/obrigat_1.gif' BORDER='0'> Unidade do Movimento
                      </td>
                      <td class="campo_tabela" valign="middle" width="75%" colspan="3">
                    ...
                    <tr height="21">
                      ...
                      <td class="campo_tabela" valign="center" width="75%" colspan="3" height="21" value="<?=$ordem?>">
                        <select size="1" name="ordem">
                          ...
                          <option value='2' <?=($ordem == '2')?"selected":""?>>Paciente</option>
                    ...
                    <tr class="campo_botao_tabela" height="21">
                      <td valign="center" align="center" width="100%" colspan="4" height="35">
                        <input type="button" style="font-size: 12px;" name="csv" id="csv" onFocus=" nextfield ='pdf'" value="  Exportar CSV  " onClick="if(validarCampos()){exportar01();}atualiza();">
                        <input type="button" style="font-size: 12px;" name="csv" id="pdf" onFocus=" nextfield ='data_in'" value=" Visualizar PDF " onClick="if(validarCampos()){exportar02();}atualiza();">
                      </td>
                    </tr>
