...
// | Arquivo ............: medicamentos_prescritor.php                               |
// | Autor ..............: Fábio Hitoshi Ide                                         |
// +---------------------------------------------------------------------------------+
// | Função .............: Tela de argumentos Relatório Medicamentos por Prescritor  |
...
function SetNamePrescritor(argumentos)
{
    ...
    document.form_argumentos.prescritor.value = valores[0];
    document.form_argumentos.prescritor01.value = valores[1];
    document.form_argumentos.prescritor02.value = valores[1];
}
...
function exportar01()
{
 document.form_argumentos.action = "relatorio_med_pre_csv.php";
...
function exportar02()
{
 document.form_argumentos.action = "relatorio_med_pre_pdf.php";
 document.form_argumentos.method = "POST";
 document.form_argumentos.target = "_blank";
 document.form_argumentos.submit();
 return false;
    ...
    function validarCampos(){
      ...
      if(x.prescritor.value=="" || x.prescritor01.value==""){
        window.alert("Preencher Campo Prescritor!");
        return false;
      }
      return true;
    }
                ...
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_argumentos" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" valign="middle" width="30%">
                        <input type="text" name="data_fn" size="15" style="width: 80px" value="<?=date("d/m/Y")?>" onFocus="nextfield ='unidade01';" onblur="verificaData(this,this.value);" onKeyPress="return mascara_data(event,this);">
                      </td>
                    </tr>
                    <tr>
                      <td class="descricao_campo_tabela" valign="middle" width="20%">
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" valign="middle" width="80%" colspan="3">
                        <input type="hidden" name="prescritor" id="prescritor" value="<?=$prescritor?>">
                        <input type="hidden" name="prescritor01" id="prescritor01" style="width: 500px">
                        <input type="text" name="prescritor02" id="prescritor02" style="width: 500px" disabled>
                    ...
                    <tr height="21">
                      ...
                      <td class="campo_tabela" valign="center" width="80%" colspan="3" height="21">
                        <select size="1" name="ordem">
                          <option value='0' <?=($ordem == '0')?"selected":""?>>Quantidade Dispensada</option>
                          <option value='1' <?=($ordem == '1')?"selected":""?>>Quantidade Prescrita</option>
                          <option value='2' <?=($ordem == '2')?"selected":""?>>Data Última Dispensação</option>
                          <option value='3' <?=($ordem == '3')?"selected":""?>>Unidade</option>
                    ...
                    <tr class="campo_botao_tabela" height="21">
                      <td valign="center" align="center" width="100%" colspan="4" height="35">
                        <input type="button" style="font-size: 12px;" name="csv" value="  Exportar CSV  " onClick="if(validarCampos()){exportar01();}">
