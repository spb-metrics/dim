...
// | Data de Criação ....: 19/01/2007 - 18:00                                        |
// | Última Atualização .: 16/03/2007 - 13:35                                        |
// | Versão .............: 1.0.0                                                     |
// +---------------------------------------------------------------------------------+
...
function exportar01()
{
 document.form_argumentos.action = "relatorio_mov_mat_csv.php";
...
function exportar02()
{
 ...
 document.form_argumentos.action = "relatorio_mov_mat_pdf.php";
 document.form_argumentos.method = "POST";
 document.form_argumentos.target = "_blank";
 
 
 document.form_argumentos.submit();
document.form_argumentos.operacao.value = 0;
 return false;
}
                    ...
                    <tr height="21">
                      ...
                      <td class="campo_tabela" valign="center" width="80%" colspan="3" height="21" value="<?=$ordem?>">
                        <select size="1" name="ordem">
                          ...
                          <option value='1' <?=($ordem == '1')?"selected":""?>>Documento</option>
                          ...
                          <option value='5' <?=($ordem == '5')?"selected":""?>>Tipo Movto</option>
                        </select>
                      </td>
                    </tr>
