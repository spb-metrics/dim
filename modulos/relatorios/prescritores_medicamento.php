...
// | Arquivo ............: prescritores_medicamento.php                               |
// | Autor ..............: Fábio Hitoshi Ide                                         |
// +---------------------------------------------------------------------------------+
// | Função .............: Tela de argumentos Relatório Prescritores por Medicamento |
...
function exportar01()
{
 document.form_argumentos.action = "relatorio_pre_med_csv.php";
...
function exportar02()
{
 document.form_argumentos.action = "relatorio_pre_med_pdf.php";
 document.form_argumentos.method = "POST";
 document.form_argumentos.target = "_blank";
 document.form_argumentos.submit();
 return false;
                  ...
                  <form name="form_argumentos" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" valign="middle" width="30%">
                        <input type="text" name="data_in" size="15" style="width: 80px" value="<?=date("d/m/Y")?>" onFocus="nextfield ='data_fn'" onblur="verificaData(this,this.value);" onKeyPress="return mascara_data(event,this);">
                        <script>
                    ...
                    <tr height="21">
                      ...
                      <td class="campo_tabela" valign="center" width="80%" colspan="3" height="21">
                        <select size="1" name="ordem">
                          ...
                          <option value='2'>Conselho Profissional</option>
                          <option value='3'>Quantidade Prescrita</option>
                          <option value='4'>Quantidade Dispensada</option>
