...
<script language="javascript">
  <!--
  function preencheCampos(id, descr, unid, opcao){
    if(opcao=="I"){
      window.opener.document.form_inclusao.codigo.value = id;
      window.opener.document.form_inclusao.descricao.value = descr;
    }
    else{
      window.opener.document.form_atendido.codigo.value = id;
      window.opener.document.form_atendido.descricao.value = descr;
      window.opener.document.form_atendido.unidade.value = unid;
    }
	window.close();
  }
  //-->
        ...
        <td height="100%" align="center" valign="top">
          <table border="0" cellspacing="1" cellpadding="0"  width="100%">
            <tr class="coluna_tabela">
              ...
              <td align="center" width="67%"> Material </td>
...
?>
                <tr class="linha_tabela" bgcolor='<?php echo $cor_linha;?>' onMouseOver="this.bgColor='#D4DFED';" onMouseOut="this.bgColor='<?php echo $cor_linha;?>'">
                  ...
                  <td align="center"><input type="radio" name="selecao" onclick="preencheCampos('<?php echo $consulta->id_material;?>', '<?php echo $consulta->descricao;?>', '<?php echo $consulta->unidade;?>', '<?php echo $_SESSION[OPCAO];?>');window.close();"></td>
                </tr>
<?php
                ////////////////////////
