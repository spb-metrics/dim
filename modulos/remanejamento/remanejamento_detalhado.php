...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: remanejamento_detalhado.php
  //  Bancos...: dbtdim
  //  Data.....: 27/11/2006
  ...
  if(file_exists("../../config/config.inc.php")){
    ...
    if($_GET[codigo]==""){
      ...
      erro_sql("Select Solicitação Selecionada", $db, "");
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0" height="100%">
                  <form name="form_detalhado" action="./remanejamento_detalhado.php" method="POST" enctype="application/x-www-form-urlencoded">
