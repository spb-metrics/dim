...
*/
  ...
  //  Função...: Tela inicial do módulo de remanejamento
  //////////////////////////////////////////////////////////////////
...
<?php
    ...
    if($_GET[i]=='f'){echo "<script>window.alert('Não foi possível realizar a solicitação de remanejamento!')</script>";}

    if($_GET[r]=='t'){echo "<script>window.alert('Operação efetuada com sucesso!')</script>";}
    if($_GET[r]=='f'){echo "<script>window.alert('Não foi possível realizar a efetivação do remanejamento!')</script>";}
  }
  ////////////////////////////////////////////
