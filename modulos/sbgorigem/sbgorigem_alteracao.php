...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: sbgorigem_alteracao.php
  //  Bancos...: dbtdim
  //  Data.....: 27/11/2006
  //  Analista.: Fabio Hitoshi Ide
  //  Função...: Tela de alteracao de subgrupo origem
  //////////////////////////////////////////////////////////////////
  ...
  if (file_exists("../../config/config.inc.php"))
  {
    ...
    if(isset($_POST[grupo]) && isset($_POST[subgrupo])){
      ...
      $sql.="set grupo_origem_id_grupo_origem='$_POST[grupo]', descricao='" . strtoupper($_POST[subgrupo]) . "', status_2='A', data_alt='$data', usua_alt='$_SESSION[id_usuario_sistema]', st_exibir_cidade = '$_POST[cidadeRadio]' ";
      $sql.="where id_subgrupo_origem='$_POST[codigo_antigo]'";
      ...
      if(mysqli_errno($db)=="0")
      {
        mysqli_commit($db);
        $aux=$_POST[aux];
        header("Location: ". URL."/modulos/sbgorigem/sbgorigem_inicial.php?a=t&".$aux);
      }
      else
      {
        mysqli_rollback($db);
        header("Location: ". URL."/modulos/sbgorigem/sbgorigem_inicial.php?a=f");
      }
    }
    else{
      if($_GET[codigo]==""){
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_alteracao" action="./sbgorigem_alteracao.php" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" colspan="2" valign="middle" width="100%">
                        <input type="text" name="subgrupo" size="30" style="width: 200px" value="<?php echo $consulta->descricao;?>">
                      </td>
                    </tr>
					<tr>
                      <td class="descricao_campo_tabela" valign="middle" width="30%">
                      ...
                      <td class="campo_tabela" colspan="2" valign="middle" width="70%">
                        <input id="cidadeSim" type="radio" name="cidadeRadio" value="S" <? echo ($consulta->st_exibir_cidade == "S") ? "checked" : "" ?> /><label for="cidadeSim">Sim</label>&nbsp;&nbsp;&nbsp;
						<input id="cidadeNao" type="radio" name="cidadeRadio" value="N" <? echo ($consulta->st_exibir_cidade == "N") ? "checked" : "" ?> /><label for="cidadeNao">N&atilde;o</label>
                      </td>
                    </tr>
                    <tr class="campo_botao_tabela" height="35">
                      <td colspan="3" valign="middle" align="right" width="100%">
                        ...
                        <input type="button" name="salvar" style="font-size: 12px;" value="Salvar >>" onclick="if(validarCampos(document.form_alteracao.grupo, document.form_alteracao.subgrupo)){document.form_alteracao.submit();}">
                      </td>
                    </tr>
