...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: status_paciente_alteracao.php
  //  Bancos...: dbtdim
  //  Data.....: 13/12/2007
  //  Analista.: Ricieri Rocha Conz
  //  Função...: Tela de alteração Conselho Profissional
  //////////////////////////////////////////////////////////////////
  ...
  if (file_exists("../../config/config.inc.php"))
  {
    ...
    if(isset($_POST[descricao])){
      ...
      $sql="update status_paciente ";
      $sql.="set descricao='" . strtoupper($_POST[descricao]) . "', flg_mostrar='$_POST[situacao]', data_alt='$data', usua_alt='$_SESSION[id_usuario_sistema]' ";
      $sql.="where id_status_paciente='$_POST[codigo_antigo]'";
      mysqli_query($db, $sql);
      erro_sql("Update Alteração Status Paciente", $db, "");
      ...
      {
        mysqli_commit($db);
        header("Location: ". URL."/modulos/statuspaciente/status_paciente_inicial.php?a=t");
      }
      else
      {
        mysqli_rollback($db);
        header("Location: ". URL."/modulos/statuspaciente/status_paciente_inicial.php?i=f");
      }
    }
    else{
      if($_GET[codigo]==""){
        ...
        erro_sql("Select Alteração Situação Paciente", $db, "");
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_alteracao" action="./status_paciente_alteracao.php" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" colspan="2" valign="middle" width="100%">
                        <input type="radio" value="S" name="situacao" <?php if($grupo_info->flg_mostrar=="S"){echo "checked";}?>> Sim
                        &nbsp; &nbsp; &nbsp; &nbsp;
                        <input type="radio" value="N" name="situacao" <?php if($grupo_info->flg_mostrar=="N"){echo "checked";}?>> Não
                      </td>
                    </tr>
