...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: status_paciente_inclusao.php
  //  Bancos...: dbtdim
  //  Data.....: 13/12/2007
  //  Analista.: Ricieri Rocha Conz
  //  Função...: Tela de inclusão Conselho Profissional
  //////////////////////////////////////////////////////////////////
  ...
  if (file_exists("../../config/config.inc.php"))
  {
    ...
    if(isset($_POST[descricao])){
      ...
      $sql="insert into status_paciente (descricao, status_2, data_incl, usua_incl, flg_mostrar) ";
      $sql.="values ('" . strtoupper($_POST[descricao]) . "', 'A', '$data', '$_SESSION[id_usuario_sistema]','$_POST[situacao]')";
      mysqli_query($db, $sql);
      erro_sql("Insert Incluir Situação Paciente", $db, "");
      ...
      {
        mysqli_commit($db);
        header("Location: ". URL."/modulos/statuspaciente/status_paciente_inicial.php?i=t");
      }
      else
      {
        mysqli_rollback($db);
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_inclusao" action="./status_paciente_inclusao.php" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" colspan="2" valign="middle" width="100%">
                        <input type="radio" value="S" name="situacao" checked>Sim
                        &nbsp; &nbsp; &nbsp; &nbsp;
                        <input type="radio" value="N" name="situacao" >Não
                      </td>
                    </tr>
