...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: subgrupo_alteracao.php
  //  Bancos...: dbtdim
  //  Data.....: 27/11/2006
  //  Analista.: Fabio Hitoshi Ide
  //  Função...: Tela de alteracao de subgrupo
  //////////////////////////////////////////////////////////////////
  ...
  if(file_exists("../../config/config.inc.php")){
    ...
    if(isset($_POST[grupo]) && isset($_POST[subgrupo])){
      ...
      $sql="update subgrupo ";
      $sql.="set grupo_id_grupo='$_POST[grupo]', descricao='" . trim(strtoupper($_POST[subgrupo])) . "', status_2='A', data_alt='$data', usua_alt='$_SESSION[id_usuario_sistema]' ";
      $sql.="where id_subgrupo='$_POST[codigo_antigo]'";
      mysqli_query($db, $sql);
      ...
      if(mysqli_errno($db)=="0"){
        mysqli_commit($db);
        $aux=$_POST[aux];
        header("Location: ". URL."/modulos/subgrupo/subgrupo_inicial.php?a=t&".$aux);
      }
      else{
        mysqli_rollback($db);
        header("Location: ". URL."/modulos/subgrupo/subgrupo_inicial.php?a=f");
      }
      exit();
    }
    else{
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_alteracao" action="./subgrupo_alteracao.php" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" colspan="2" valign="middle" width="100%">
                        <input type="text" name="codigo" size="30" style="width: 200px" disabled value="<?php echo $consulta->id_subgrupo;?>">
                      </td>
                    </tr>
                    <tr>
                      <td class="descricao_campo_tabela" valign="middle" width="20%">
                    ...
                    <tr>
                      ...
                      <td class="campo_tabela" colspan="2" valign="middle" width="100%">
                        <input type="text" name="subgrupo" size="30" style="width: 500px" value="<?php echo $consulta->descricao;?>">
                      </td>
                    </tr>
