...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: tconselho_profissional_alteracao.php
  //  Bancos...: dbtdim
  //  Data.....: 13/12/2007
  ...
  if (file_exists("../../config/config.inc.php"))
  {
    ...
    if(isset($_POST[descricao])){
      ...
      $sql="update tipo_conselho ";
      $sql.="set descricao='" . strtoupper($_POST[descricao]) . "', status_2='A', data_alt='$data', usua_alt='$_SESSION[id_usuario_sistema]' ";
      $sql.="where id_tipo_conselho='$_POST[codigo_antigo]'";
      mysqli_query($db, $sql);
      erro_sql("Update Alteração Conselho Profissional", $db, "");
      ...
      if(mysqli_errno($db)=="0")
      {
        mysqli_commit($db);
        $aux=$_POST[aux];
        header("Location: ". URL."/modulos/tconselho/tconselho_profissional_inicial.php?a=t&".$aux);
      }
      else
      {
        mysqli_rollback($db);
        header("Location: ". URL."/modulos/tconselho/tconselho_profissional_inicial.php?i=f");
      }
    }
    else{
      if($_GET[codigo]==""){
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_alteracao" action="./tconselho_profissional_alteracao.php" method="POST" enctype="application/x-www-form-urlencoded">
