...
*/
  ...
  /////////////////////////////////////////////////////////////////
  //  Sistema..: DIM
  //  Arquivo..: tconselho_profissional_inclusao.php
  //  Bancos...: dbtdim
  //  Data.....: 13/12/2007
  ...
  if (file_exists("../../config/config.inc.php"))
  {
    ...
    if(isset($_POST[descricao])){
      ...
      $sql="insert into tipo_conselho (descricao, status_2, data_incl, usua_incl) ";
      $sql.="values ('" . strtoupper($_POST[descricao]) . "', 'A', '$data', '$_SESSION[id_usuario_sistema]')";
      mysqli_query($db, $sql);
      erro_sql("Insert Incluir Tipo de Conselho", $db, "");
      ...
      {
        mysqli_commit($db);
        header("Location: ". URL."/modulos/tconselho/tconselho_profissional_inicial.php?i=t");
      }
      else
      {
        mysqli_rollback($db);
            ...
            <tr>
              <td colspan='8'>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                  <form name="form_inclusao" action="./tconselho_profissional_inclusao.php" method="POST" enctype="application/x-www-form-urlencoded">
                    ...
                    <tr class="campo_botao_tabela" height="35">
                      <td colspan="3"valign="middle" align="right" width="100%">
                        <input type="button" style="font-size: 12px;" name="voltar" value="<< Voltar" onclick="window.location='<?php echo URL;?>/modulos/tconselho/tconselho_profissional_inicial.php'">
