 ...
 if($_GET[id_unidade]!=""){
   ...
   if(isset($_POST[id_unidade])){
     ...
     if(mysqli_errno($db)=="0"){
       mysqli_commit($db);
       $aux=$_POST[aux];
       header("Location: ". URL."/modulos/unidade/unidade_inicial.php?e=t&".$aux);
     }
     else{
       mysqli_rollback($db);
       header("Location: ". URL."/modulos/unidade/unidade_inicial.php?e=f");
     }
     exit();
   }
 }
    ...
    <!--
      function trataDados(){
        ...
        if(info=="SAV"){
          ...
          var msg="Unidade não pode ser excluída. Existem unidades relacionadas a ela!\n";
          window.alert(msg);
        }
      }
      ...
      function verificarExclusao(){
        ...
        var url = "../../xml/unidadeExclusao.php?id=" + id;
    ...
    <tr height="5%">
      <td>
        <table width="100%" class="titulo_tabela" height="21">
          <tr><td align="center"><? echo $nome_aplicacao; ?>: Excluir</td></tr>
        </table>
      </td>
    </tr>
    <tr>
      <td align="center" valign="top">
        <table width="100%" border="0" cellpadding="0" cellspacing="1">
          <form name="form_exclusao" action="./unidade_exclusao.php" method="POST" enctype="application/x-www-form-urlencoded">
            <tr>
              ...
              <td align="left" width="25%" class="campo_tabela">
                <select name="nome_und_sup" style="width:205px;" disabled>
                  ...
                  <?
                    ...
                    $und_superior=mysqli_query($db, $sql);
                    erro_sql("Select Unidade Superior", $db, "");
                    if(mysqli_num_rows($und_superior)>0){
                      while($lista_und_superior=mysqli_fetch_object($und_superior)){
                        if($lista_und_superior->id_unidade==$unidade_id_unidade){
                  ?>
                          <option value="<?php echo $lista_und_superior->id_unidade; ?>" selected><?php echo $lista_und_superior->nome; ?></option>
                  <?
                        }
                        else{
                  ?>
                          <option value="<?php echo $lista_und_superior->id_unidade; ?>"><?php echo $lista_und_superior->nome; ?></option>
                  <?
                        }
                      }
                    }
            ...
            <!-- Inicio Glaison -->
                    ...
                    <tr>
                        <td  colspan = "4" align="left" width="25%" class="descricao_campo_tabela">
                         ...
                         <td  colspan = "4" align="left" width="25%"  class="campo_tabela">
                             <input type="radio" name="flgBanco" value="1" <?php if ($flgBanco=='1'){echo "checked";}?> disabled> IMA &nbsp&nbsp&nbsp
                             <input type="radio" name="flgBanco" value="0" <?php if ($flgBanco!='1'){echo "checked";}?> disabled>Unidades
              ...
              <TR>
                     ...
                     <input type="text" name="dns_local" id= "dns_local" size="102" maxlength="70" value="<?php echo $dns_local;?> "disabled>
                     </td>
              </TR>
               ...
               <tr>
				   <td colspan="4" align="left" class="descricao_campo_tabela"><img
                    ...
                    <input type="text" name="base_integra_ima" id="base_integra_ima" size="102"	maxlength="20"  value="<?php echo $base_integra_ima;?>" disabled>
                    </td>
			  </tr>
          ...
          <tr>
              ...
              <td    align="left"  width="25%"  class="campo_tabela">
                <input type="text" name="usuario_integra_local" id="usuario_integra_local" size="30" maxlength="15"  value="<?php echo $usuario_integra_local;?>"disabled>
              </td>
              <td   align="left" width="25%"  class="descricao_campo_tabela">
                <img src="<? echo URL."/imagens/obrigat_1.gif";?>">Senha
              </td>
              <td  align="left" width="25%" class="campo_tabela">
                <input type="password" name="senha_integra_local" id="senha_integra_local" size="31" maxlength="15" value="<?php echo $senha_integra_local;?>"disabled>
              </td>
          </tr>
          ...
          <tr>
              ...
              <td  colspan = "4" align="left" width="25%"  class="campo_tabela">
                  <input type="radio" name="flg_transfalmo" value="s" <?php if($flg_transfalmo =='s'){echo "checked";}?> "disabled>Sim &nbsp&nbsp&nbsp
                  <input type="radio" name="flg_transfalmo" value="n" <?php if($flg_transfalmo !='s'){echo "checked";}?> "disabled>Não
              </td>
          </tr>
               </TABLE>
          ...
          <!-- Fim Glaison -->
            ...
            <tr>
              <td colspan="4" align="right" class="descricao_campo_tabela" height="35">
                ...
                <input style="font-size: 12px;" type="button" name="excluir"  value="Excluir >>" onclick="verificarExclusao();">
			...
			<input type="hidden" id="aux" name="aux" value="pagina=<?=$_GET[pagina]?>&pagina_a_exibir=<?=$_GET[pagina_a_exibir]?>&indice=<?=$_GET[indice]?>&buscar=<?=$_GET[buscar]?>">
		  </form>
        </table>
      </td>
    </tr>
