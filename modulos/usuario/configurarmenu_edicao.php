...
if (file_exists("../../config/config.inc.php"))
{
 ...
 else
 {
   	     $sql_exclusao = "update item_menu
                   set item_menu_id_item_menu = '$_POST[item_menu_id_item_menu]',
                       aplicacao_id_aplicacao = '$_POST[aplicacao]',
         ...
         if(mysqli_errno($db)=="0")
         {
          mysqli_commit($db);
          $aux=$_POST[aux];
          header("Location: ". URL."/modulos/usuario/configurarmenu_inicial.php?a=t&".$aux);
         }
         else
         {
          mysqli_rollback($db);
          header("Location: ". URL."/modulos/usuario/configurarmenu_inicial.php?a=f");
         }
 }
    ...
    <tr>
      <td align="center" valign="top">
          <table width="100%" border="0" cellpadding="0" cellspacing="1">
            <form name="cadastro" id="cadastro" action="./configurarmenu_edicao.php" method="POST" enctype="application/x-www-form-urlencoded">
            ...
            <tr>
              ...
              <td align="left" width="70%" class="campo_tabela">
                <input type="text" name="id_item_menu" id="id_item_menu" size="30" maxlength="10" <?php if (isset($id_item_menu)){echo "value='".$id_item_menu."'";}?>disabled>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" width="70%" class="campo_tabela">
                <input type="text" name="descricao" id="descricao" size="80" maxlength="120" <?php if (isset($descricao)){echo "value='".$descricao."'";}?>>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" width="70%" class="campo_tabela">
                <input type="text" name="ordem" id="ordem" size="30" maxlength="10" <?php if (isset($ordem)){echo "value='".$ordem."'";}?>  onKeyPress="return isNumberKey(event);" >
              </td>
            </tr>
            ...
            <tr>
              <td colspan="2" align="right" class="descricao_campo_tabela" height="35">
                ...
                <input type="hidden" name="id_item_menu" id="id_item_menu" <?php if (isset($id_item_menu)){echo "value='".$id_item_menu."'";}?> >
