...
//error_reporting(E_ALL);
  ...
  while($combo_info=mysqli_fetch_object($result)){
    $xml.="<combo>\n";
    $xml.="<codigo>" . $combo_info->unidade_id_unidade . "</codigo>\n";
    $xml.="<descricao>" . $combo_info->nome . "</descricao>\n";
    $xml.="</combo>\n";
  }
  $xml.="</combos>";
