...
*/
  ...
  //$operacao=87998;  // valor vindo da variavel params de combo.js

  $sql = "select concat(concat(p.id_profissional,'|',p.tipo_prescritor_id_tipo_prescritor),'|', p.inscricao) as codigo,
                 concat(p.nome,'/',e.uf) as nome
          from
                 profissional p,
                 estado e
          where
                 p.id_profissional =$operacao
